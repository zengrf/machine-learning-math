...
# ------------------------------
# Simple NumPy MLP (8 hidden layers)
# ------------------------------

@dataclass
class MLPConfig:
    input_dim: int = 27
    hidden_dims: Tuple[int, ...] = (64, 64, 64, 64, 32, 32, 16, 16)
    output_dim: int = 2
    lr: float = 1e-3
    beta1: float = 0.9
    beta2: float = 0.999
...
if __name__ == "__main__":
    ...
    train_and_evaluate(epochs=100, per_degree_n=10_000, train_frac=0.75, lr=1e-3, fast=fast)
